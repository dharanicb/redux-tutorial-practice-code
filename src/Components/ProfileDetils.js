...
import { addProfile } from './ExpensesSlice';
    ...
    return (
        <form className='mt-[4%] text-center' onSubmit={onSubmitDetails}>
            ...
            <div className='mt-[10px] text-[white]'>
                ...
                <input type="text" id = "name" className='ml-[60px] bg-slate-200 text-[black]' onChange={e => setProfile({...profile,name:e.target.value})}/><br></br>
                <label className='mt-[10px]' htmlFor='email'>Email :</label>
                <input type="email" id = "email" className='ml-[60px] bg-slate-200 text-[black]' onChange={e => setProfile({...profile,email:e.target.value})}/><br></br>
                <label className='mt-[10px]' htmlFor='phone'>phone number :</label>
                <input type="phone" id = "phone" className='ml-[5px] bg-slate-200 text-[black]'onChange={e => setProfile({...profile,phoneNo:e.target.value})}/><br></br>
                ...
                <input type="text" id = "occupation" className='ml-[28px] bg-slate-200 text-[black]'onChange={e => setProfile({...profile,occupation:e.target.value})}/><br></br>
                <label className='mt-[10px]' htmlFor='address'>Address :</label>
                <input type="text" id = "address" className='ml-[40px] bg-slate-200 text-[black]' onChange={e => setProfile({...profile,address:e.target.value})}/><br></br>
